...
async function load_context() {
  ...
  member = new anchor.web3.PublicKey(config.member);
  memberSigner = new anchor.web3.PublicKey(config.memberSigner);

  unlockedVendor = new anchor.web3.PublicKey(config.unlockedVendor);
  unlockedVendorVault = new anchor.web3.PublicKey(config.unlockedVendorVault);
  unlockedVendorSigner = new anchor.web3.PublicKey(config.unlockedVendorSigner);
  ...
  try {
    tx = await main_staking_program.rpc.endUnstake({
      accounts: {
        ...
        vaultPendingWithdraw: memberAccount.balances.vaultPendingWithdraw,
